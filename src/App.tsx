...
function App() {
  ...
  // Modal state for portfolio items
  ...
  const goToPreviousProject = () => {
    if (selectedProject) {
      const currentIndex = portfolioImages.findIndex(p => p.id === selectedProject.id);
      const prevIndex = currentIndex > 0 ? currentIndex - 1 : portfolioImages.length - 1;
      setSelectedProject(portfolioImages[prevIndex]);
      setCurrentImageIndex(0);
    }
  };
  ...
  const goToNextProject = () => {
    if (selectedProject) {
      ...
      setSelectedProject(portfolioImages[nextIndex]);
      setCurrentImageIndex(0);
    }
  };
  ...
  return (
    <div className="bg-white text-gray-900 font-sans">
          ...
          <div className="flex justify-between items-center h-22">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} href="#" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-lg font-medium transition">Início</a>
                <a onClick={() => scrollToSection('portfolio')} href="#portfolio" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-lg font-medium transition">Portfólio</a>
                <a onClick={() => scrollToSection('about')} href="#about" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-lg font-medium transition">Sobre</a>
                <a onClick={() => scrollToSection('contact')} href="#contact" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-lg font-medium transition">Contato</a>
              </div>
            </div>
      ...
      {/* Seção Principal */}
      <section className="bg-gray-100 min-h-screen flex items-center pt-8 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Acesse nossas redes sociais para mais informações.
              </p>
              <div className="flex space-x-4">
                ...
                <a href="#" aria-label="Instagram" className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-600 text-sm">info@pintepinturas.com.br</span>
                </li>
